...
window.leadStore = {
  ...
  addLead: function addLead(leadData) {
    ...
    // Push every lead to the Google Sheet + email notification webhook
    fetch(window.LEAD_WEBHOOK_URL, {
      ...
      console.log('Lead webhook sync failed (saved locally regardless)', err);
    });
    return newLead;
  },
...
window.Header = function (_ref) {
  ...
  }, "1800-890-5266"))))), React.createElement("nav", {
...
window.HeroSection = function (_ref2) {
  ...
  }, React.createElement("span", null, "\uD83C\uDDEE\uD83C\uDDF3 India's #1 AI-Powered Online Degree Portal")), React.createElement("h2", {
...
window.FilterSidebar = function (_ref4) {
  ...
  return React.createElement("aside", {
    ...
    onClick: function onClick() {
      return window.open('https://wa.me/919599128500?text=Hi%20UniversityJano,%20I%20need%20help%20choosing%20an%20online%20degree', '_blank');
    }
  }, "\uD83D\uDCAC WhatsApp Counselor")));
};
...
window.FloatingWidgets = function (_ref13) {
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", {
    ...
    onClick: function onClick() {
      return window.open('https://wa.me/919599128500?text=Hi%20UniversityJano,%20I%20need%20help%20choosing%20an%20online%20degree%20program', '_blank');
    },
...
function App() {
  ...
  // Legacy hash-URL redirect: every page now has its own real, dedicated
  // URL (no #/ routes). This only exists to send old bookmarked #/... links
  // to the correct real page.
  useEffect(function () {
    ...
    if (hash.startsWith('#/university/')) {
      ...
      window.location.replace(found ? "/universities/".concat(found.slug, ".html") : '/universities/index.html');
    } else if (hash === '#/universities') {
      window.location.replace('/universities/index.html');
    } else if (hash === '#/compare') {
      window.location.replace('/compare.html');
    } else if (hash === '#/roi-calculator') {
      window.location.replace('/roi-calculator.html');
    } else if (hash === '#/emi-calculator') {
      window.location.replace('/emi-calculator.html');
    } else if (hash === '#/ugc-verifier') {
      window.location.replace('/ugc-verifier.html');
    }
  }, []);

  // Real-URL navigation. Every destination is a real, dedicated, crawlable
  // URL — this is always a normal page load, never a hash change.
  var navigateTo = function navigateTo(pageName) {
    ...
    if (pageName === 'university' && uni) {
      window.location.href = "/universities/".concat(uni.slug, ".html");
    } else if (pageName === 'universities') {
      window.location.href = "/universities/index.html";
      ...
      window.location.href = "/ugc-verifier.html";
    } else {
